...
let exportedMethods = {
    ...
    getEvent: (id) => {
        ...
        let event = eventList.filter(x => x.id === Number(id)).shift();
    ...
    getEventsForAttendee: (attendeeId) => {
        ...
        //return a events list for given attendees
        //let t=typeof attendeeId;
        //console.log(attendeeId,t);
        var res=eventList.filter(x => x.attendees.indexOf(attendeeId) >= 0);
